temp = table2array(adult(:,2));
one_hot_workclass = zeros(32561,9);
...
temp = table2array(adult(:,4));
one_hot_education = zeros(32561,17);
[size1,size2] = size(temp);
for i = 1:size1
   if(temp(i) == '?')
...
% Unknown                              10000000
temp = table2array(adult(:,6));
one_hot_marital = zeros(32561,8);
[size1,size2] = size(temp);
for i = 1:size1
   if(temp(i) == '?')
...
temp = table2array(adult(:,7));
one_hot_occupation = zeros(32561,15);
[size1,size2] = size(temp);
for i = 1:size1
   if(temp(i) == '?')
...
% Unmarried                 0100000
% Unknown                   1000000
temp = table2array(adult(:,8));
one_hot_relationship = zeros(32561,7);
[size1,size2] = size(temp);
for i = 1:size1
   if(temp(i) == '?')
...
% Black                             010000
% Unknown                           100000
temp = table2array(adult(:,9));
one_hot_race = zeros(32561,6);
[size1,size2] = size(temp);
for i = 1:size1
   if(temp(i) == '?')
       one_hot_race(i,1) = 1;
...
% Male     010
% Unknown  100
temp = table2array(adult(:,10));
one_hot_sex = zeros(32561,3);
[size1,size2] = size(temp);
for i = 1:size1
   if(temp(i) == '?')
       one_hot_sex(i,1) = 1;
...
% other         010
% Unknown       100
temp = table2array(adult(:,14));
one_hot_country = zeros(32561,3);
[size1,size2] = size(temp);
for i = 1:size1
   if(temp(i) == '?')
...
% >50K    01
% <=50K   10
temp = table2array(adult(:,15));
one_hot_class = zeros(32561,1);
[size1,size2] = size(temp);
for i = 1:size1
   if(temp(i) == '<=50K')
       one_hot_class(i,1) = 1;
...
%methods
Final_input = zeros(32561,74);
Final_output = zeros(32561,2);
Final_input(:,1) = table2array(adult(:,1));
Final_input(:,1) = (Final_input(:,1)- mean(Final_input(:,1)))/std(Final_input(:,1));
Final_input(:,2:10) = one_hot_workclass;
Final_input(:,11) = table2array(adult(:,3));
Final_input(:,11) = (Final_input(:,11)- mean(Final_input(:,11)))/std(Final_input(:,11));
Final_input(:,12:28) = one_hot_education;
Final_input(:,29) = table2array(adult(:,5));
Final_input(:,29) = (Final_input(:,29)- mean(Final_input(:,29)))/std(Final_input(:,29));
Final_input(:,30:37) = one_hot_marital;
Final_input(:,38:52) = one_hot_occupation;
Final_input(:,53:59) = one_hot_relationship;
Final_input(:,60:65) = one_hot_race;
Final_input(:,66:68) = one_hot_sex;
Final_input(:,69) = table2array(adult(:,11));
Final_input(:,69) = (Final_input(:,69)- mean(Final_input(:,69)))/std(Final_input(:,69));
Final_input(:,70) = table2array(adult(:,12));
Final_input(:,70) = (Final_input(:,70)- mean(Final_input(:,70)))/std(Final_input(:,70));
Final_input(:,71) = table2array(adult(:,13));
Final_input(:,71) = (Final_input(:,71)- mean(Final_input(:,71)))/std(Final_input(:,71));
Final_input(:,72:74) = one_hot_country;
Final_output = one_hot_class;
k=1; v=1;
% for i = 1:32561
%    if(Final_input(i,1) == '?')
%        loca1(k) = i;
